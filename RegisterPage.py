...
class RegisterPage(Page):
    def __init__(self):
        ...
        self.full_name_input = InputBox(250, 170, 140, 32)
        ...
        self.input_boxes1 = [self.full_name_input, self.password_input, self.institute_input, self.id_input, self.gender_input, self.age_input]
    ...
    def handle_page(self):
        for event in pygame.event.get():
            ...
            if self.student_button.is_clicked(event):
                self.user_type_input = UserType.student
